import { Stack, Typography, Rating ,Box, Chip,Button} from '@mui/material'
    ...
    >
      ...
      <Box>
        <Rating
          ...
          readOnly
        />
        <Typography>{`(${reviewers_count})`}</Typography>
        <Box
          onClick={handeLike}
          sx={{
            position: 'absolute',
        ...
        >
          {view ? <VisibilityOffOutlinedIcon /> : <RemoveRedEyeOutlinedIcon />}
        </Box>
        <Box
          sx={{
            position: 'absolute',
